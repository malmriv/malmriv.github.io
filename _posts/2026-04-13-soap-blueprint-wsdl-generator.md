...
I ran into this problem often enough that I built a small tool to solve it a while ago. It worked, but it had some serious limitations that eventually caught up with me. So I rewrote it from scratch. The result is [SOAP Blueprint](https://github.com/malmriv/soap-blueprint), and I think it turned out rather well.
